...
class ConfigController extends Controller
{
    public function geocode_api(Request $request)
    {
        ...
        // $response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng=' . $request->lat . ',' . $request->lng . '&key=' . $request->key);
        $response = Http::get('https://nominatim.openstreetmap.org/reverse?format=json&lat=' . $request->lat . '&lon=' . $request->lng);
